...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 31, name: "Fight a Goblin", type: TaskType.Mandatory, cost_multiplier: 3.5, skills: [SkillType.Combat] }),
            ...
            new TaskDefinition({ id: 36, name: "Goblin Warlord", type: TaskType.Boss, cost_multiplier: 1300, skills: [SkillType.Combat], xp_mult: 0.3, item: ItemType.GoblinWaraxe, unlocks_task: 37 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 47, name: "Angry Ent", type: TaskType.Boss, cost_multiplier: 12000, skills: [SkillType.Combat], xp_mult: 0.3, unlocks_task: 48, item: ItemType.MagicalRoots }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 67, name: "Bandits", type: TaskType.Boss, cost_multiplier: 10000, skills: [SkillType.Combat], xp_mult: 0.3, item: ItemType.BanditWeapons, unlocks_task: 68 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 74, name: "Negotiate with a Rogue Guard Captain", cost_multiplier: 12, max_reps: 1, xp_mult: 0.3, skills: [SkillType.Charisma, SkillType.Subterfuge], perk: PerkType.UndergroundConnection }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 81, name: "Investigate Rumors of a Great Magician", type: TaskType.Mandatory, cost_multiplier: 1.5, max_reps: 4, skills: [SkillType.Charisma, SkillType.Search] }),
            new TaskDefinition({ id: 82, name: "Search the Archives for Magic Spells", type: TaskType.Mandatory, cost_multiplier: 1.2, max_reps: 5, skills: [SkillType.Study, SkillType.Search] }),
            ...
            new TaskDefinition({ id: 88, name: "Figure Out How to Attune", cost_multiplier: 300, xp_mult: 0.1, skills: [SkillType.Study, SkillType.Magic], perk: PerkType.Attunement }),
            ...
            new TaskDefinition({ id: 87, name: "Corrupt Mayor", type: TaskType.Boss, cost_multiplier: 10000, skills: [SkillType.Combat], xp_mult: 0.3, item: ItemType.CityChain, unlocks_task: 89 }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 98, name: "Werewolf", type: TaskType.Boss, cost_multiplier: 20000, skills: [SkillType.Combat], xp_mult: 0.3, item: ItemType.WerewolfFur, unlocks_task: 99 }),
            new TaskDefinition({ id: 99, name: "Gather Shed Fur from Werewolf Lair", cost_multiplier: 8, max_reps: 3, skills: [SkillType.Subterfuge], item: ItemType.WerewolfFur, hidden_by_default: true }),
        ],
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 104, name: "Learn Magical Trance", cost_multiplier: 2.5, max_reps: 6, xp_mult: 0.2, skills: [SkillType.Magic, SkillType.Study], perk: PerkType.DeepTrance }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 127, name: "PLACEHOLDER", type: TaskType.Boss, cost_multiplier: 15000, xp_mult: 0.2, skills: [SkillType.Combat] }),
        ],
    },
    {
        name: "The Desert",
        tasks: [
            ...
            new TaskDefinition({ id: 137, name: "Giant Sandworm", type: TaskType.Boss, cost_multiplier: 15000, xp_mult: 0.2, skills: [SkillType.Combat] }),
        ],
    },
    {
        name: "The Oasis",
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 151, name: "Apologize for Stealing Reagents", type: TaskType.Mandatory, cost_multiplier: 10, max_reps: 3, skills: [SkillType.Charisma], xp_mult: 0.2 }),
