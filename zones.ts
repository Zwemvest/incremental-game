...
export const ZONES: Zone[] = [
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 64, name: "Get Used to Traveling", cost_multiplier: 3, max_reps: 3, xp_mult: 2, skills: [SkillType.Travel], perk: PerkType.ExperiencedTraveler }),
    ...
    },
    {
        ...
        tasks: [
            ...
            new TaskDefinition({ id: 74, name: "PLACEHOLDER", cost_multiplier: 5, max_reps: 6, xp_mult: 0.2, skills: [SkillType.Magic, SkillType.Study], perk: PerkType.Zone7 }),
