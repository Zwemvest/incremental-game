...
export const ZONES: Zone[] = [
    ...
    },
    {
        name: "The Forest",
        tasks: [
            new TaskDefinition({ id: 90, name: "Scale the Mountain", type: TaskType.Travel, cost_multiplier: 8, skills: [SkillType.Travel], perk: PerkType.HighAltitudeClimbing }),
            ...
            new TaskDefinition({ id: 94, name: "Prepare to Scale the Mountain", cost_multiplier: 7, max_reps: 3, xp_mult: 4, skills: [SkillType.Survival, SkillType.Study] }),
            ...
            new TaskDefinition({ id: 97, name: "Angry Ent", type: TaskType.Boss, cost_multiplier: 6000, skills: [SkillType.Combat], xp_mult: 0.3 }),
        ],
    },
    {
